...
$db['mongo']['username'] = 'replaceme';
$db['mongo']['password'] = 'replaceme';
$db['mongo']['hostname'] = 'localhost';
$db['mongo']['database'] = 'replaceme';
$db['mongo']['dbdriver'] = '';
$db['mongo']['dbprefix'] = '';
$db['mongo']['pconnect'] = FALSE;
$db['mongo']['db_debug'] = FALSE;
$db['mongo']['cache_on'] = FALSE;
$db['mongo']['cachedir'] = '';	
$db['mongo']['char_set'] = 'utf8';
$db['mongo']['dbcollat'] = 'utf8_general_ci';

$db['dev']['username'] = 'replaceme';
$db['dev']['password'] = 'replaceme';
$db['dev']['hostname'] = 'localhost';
$db['dev']['database'] = 'replaceme.1';
...
$db['live']['username'] = 'replaceme';
$db['live']['password'] = 'replaceme';
$db['live']['hostname'] = 'localhost';
$db['live']['database'] = 'replaceme';
