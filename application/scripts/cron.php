...
*/
    ...
    define('CRON_CI_INDEX', '/server/git/iburnd/index.php');   // Your CodeIgniter main index.php file
    define('CRON', FALSE);   // Test for this in your controllers if you only want them accessible via cron
